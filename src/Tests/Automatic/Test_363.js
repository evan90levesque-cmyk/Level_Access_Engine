	...
	aeKernel.addAutomaticTest("363", {
		...
		testFunc: function() {
			return new AutoTestShell(
				...
				'track[data-ae_ar="null"][data-ae_vis][data-ae_avat][kind="chapters"]:not([srclang]),track[data-ae_ar="null"][data-ae_vis][data-ae_avat][kind="chapters"][srclang=""]'
			);
		}
	});
}
