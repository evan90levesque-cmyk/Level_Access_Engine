...
export function test22() {
	aeKernel.addAutomaticTest("22", {
		...
		fixType: "",
		testFunc: function() {
			const relevantCssSelector = 'a[data-ae_vis][data-ae_ar="null"]';
			...
			testShell.set_candidateSetNodesFunc(function() {
				...
				for (let i = 0; i < res.length; i++) {
					...
					const res1 = result.querySelector('input[data-ae_ar="null"]:not([type="hidden"]), keygen[data-ae_ar="null"], select[data-ae_ar="null"], textarea[data-ae_ar="null"], button[data-ae_ar="null"]');
					if (res1) {
