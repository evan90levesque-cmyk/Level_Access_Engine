 ...
 */
export function test239() {
	aeKernel.addStage1MarkdownFunc("getBefore_FromStyles", getBefore_FromStyles);
	aeKernel.addStage1MarkdownFunc("getAfter_FromStyles", getAfter_FromStyles);
	aeKernel.addStage4MarkdownFunc("calcAccNamesForCertainElements", calcAccNamesForCertainElements);

	aeKernel.addGuidedAutomaticTest("239", {
		bestPractice: 1301,
		testId: 239,
		introduced: "1.0",
		mediaType: mediaTypes.WEB,
		description: "One or more A elements, without an ARIA-assigned role, not intentionally hidden in the DOM and available to assistive technologies, has a suspicious calculated accessible name value.",
		metaText: "This A element has a suspicious (i.e. lacks purpose or is >150 characters) calculated accessible name value",
		metaTextDetail: "This A element has a suspicious (i.e. lacks purpose or is >150 characters) calculated accessible name value of: {{data-ae_an}}",
		fixType: {
			"fixType": 1,
			"domSpec": false,
		...
		testFunc: function() {
			const relevantCssSelector = 'a[data-ae_vis][data-ae_avat][data-ae_ar="null"][data-ae_an]';
