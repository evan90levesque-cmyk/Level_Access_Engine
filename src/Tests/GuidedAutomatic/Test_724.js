 ...
 */
export function test724() {
	aeKernel.addStage1MarkdownFunc("getBefore_FromStyles", getBefore_FromStyles);
	aeKernel.addStage1MarkdownFunc("getAfter_FromStyles", getAfter_FromStyles);
	aeKernel.addStage4MarkdownFunc("calcAccNamesForCertainElements", calcAccNamesForCertainElements);

	aeKernel.addGuidedAutomaticTest("724", {
		bestPractice: 373,
		testId: 724,
		introduced: "2.15",
		mediaType: mediaTypes.WEB,
		description: "One or more button elements, without an aria-assigned role, not intentionally hidden in the DOM and available to assistive technologies, has a suspicious accessible name value (i.e. under 4 characters long).",
		metaText: "This button element has a suspicious accessible name",
		metaTextDetail: "This button element has a suspicious accessible name value of: {{data-ae_an}}",
		fixType: "",
		testFunc: function() {
			const relevantCssSelector = 'button[data-ae_ar="null"][data-ae_vis][data-ae_avat][data-ae_an]';
