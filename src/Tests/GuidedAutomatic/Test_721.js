 ...
 */
export function test721() {
	aeKernel.addStage1MarkdownFunc("getBefore_FromStyles", getBefore_FromStyles);
	aeKernel.addStage1MarkdownFunc("getAfter_FromStyles", getAfter_FromStyles);
	aeKernel.addStage4MarkdownFunc("calcAccNamesForCertainElements", calcAccNamesForCertainElements);

	aeKernel.addGuidedAutomaticTest("721", {
		bestPractice: 338,
		testId: 721,
		introduced: "2.15",
		mediaType: mediaTypes.WEB,
		description: "One or more textarea elements, without an aria-assigned role, not intentionally hidden in the DOM and available to assistive technologies, has a suspicious accessible name value (i.e. under 4 characters long).",
		metaText: "This textarea element has a suspicious accessible name",
		metaTextDetail: "This textarea element has a suspicious accessible name value of: {{data-ae_an}}",
		fixType: "",
		testFunc: function() {
