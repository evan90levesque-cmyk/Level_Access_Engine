describe('String N/A: no img nodes', function() {
    it('no img nodes should be equal to na', function() {
       ...
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1108");
       expect(res).toBe('na');
       // </variant1>
       // <variant2>
       res = LevelAccess_AccessEngine.runTest_returnNumbers("1108");
       expect(res).toBe("");       // </variant2>
       // <variant3>
       res = LevelAccess_AccessEngine.runTest_returnInstances("1108");
...
describe('String Fail: img node with alt="" and an aria-labelledby attribute attribute', function() {
    it('img node with alt="" and an aria-labelledby attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<div id='test1'>Helpful text</div><img alt='' aria-labelledby='test1' src='test.gif'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1108");
       ...
       // <variant2>
       res = LevelAccess_AccessEngine.runTest_returnNumbers("1108");
       expect(res).toBe("1108,1");       // </variant2>
       // <variant3>
       res = LevelAccess_AccessEngine.runTest_returnInstances("1108");
...
describe('String Fail: img node with alt="" and an empty aria-labelledby attribute attribute', function() {
    it('img node with alt="" and an empty aria-labelledby attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<img alt='' aria-labelledby='' src='test.gif'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1108");
       expect(res).toBe('fail');
...
describe('String Fail: img node with alt="", role=img and an aria-labelledby attribute attribute', function() {
    it('img node with alt="", role=img and an aria-labelledby attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<div id='test1'>Helpful text</div><img role='img' alt='' aria-labelledby='test1' src='test.gif'></img>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1108");
       expect(res).toBe('fail');
...
describe('String Fail: img node with alt="", role=img and an empty aria-labelledby attribute attribute', function() {
    it('img node with alt="", role=img and an empty aria-labelledby attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<img role='img' alt='' aria-labelledby='' src='test.gif'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1108");
       expect(res).toBe('fail');
