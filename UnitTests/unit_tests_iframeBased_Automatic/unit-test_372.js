describe('String N/A: no input nodes', function() {
    it('no input nodes should be equal to na', function() {
       ...
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('na');
       // </variant1>
       // <variant2>
       res = LevelAccess_AccessEngine.runTest_returnNumbers("372");
       expect(res).toBe("");       
       // </variant2>
       // <variant3>
       res = LevelAccess_AccessEngine.runTest_returnInstances("372");
       expect(res).toBe(null);
       // </variant3>
    });
});

describe('String N/A: input node with a role set to a email value that starts with presentation', function() {
    it('input node with a role set to a email value that starts with presentation should be equal to na', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String N/A: an input node with an aria-label attribute set to "alternative" that is not available in the DOM', function() {
    it('an input node with an aria-label attribute set to "alternative" that is not available in the DOM should be equal to na', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<input style='display:none' type='email' aria-label='alternative'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('na');
...
describe('String N/A: input node with a type attribute set to the email value "hidden"', function() {
    it('input node with a type attribute set to the email value "hidden" should be equal to na', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String Pass: input node with an aria-labelledby attribute', function() {
    it('input node with an aria-labelledby attribute should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<span id='label1'>Label</span><input type='email' aria-labelledby='label1'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
...
describe('String Pass: input node with an aria-label attribute', function() {
    it('input node with an aria-label attribute should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<input type='email' aria-label='label1'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('pass');
       ...
       // </variant2>
       // <variant3>
       var res = LevelAccess_AccessEngine.runTest_returnInstances("372");
       expect(res).toBe(null);
       // </variant3>
    });
});
...
describe('String Pass: input node with an explicitly associated label node', function() {
    it('input node with an explicitly associated label node should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<label for='test'>label</label><input type='email' id='test'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('pass');
...
describe('String Pass: input node with an implicitly associated label node', function() {
    it('input node with an implicitly associated label node should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<label for='test'>label<input type='email' id='test'></label>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('pass');
...
describe('String Pass: input node with a title attribute', function() {
    it('input node with a title attribute should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<input type='email' title='label1'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('pass');
...
describe('String Fail: input node with an aria-labelledby attribute set to a null value', function() {
    it('input node with an aria-labelledby attribute set to a null should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<span id='label1'>Label</span><input type='email' aria-labelledby=''>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('fail');
...
describe('String Fail: input node with an aria-labelledby attribute set to a bad value', function() {
    it('input node with an aria-labelledby attribute set to a bad should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<span id='label1'>Label</span><input type='email' aria-labelledby='bad'>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('fail');
...
describe('String Fail: input node with an aria-labelledby attribute set to a good value; but the target is empty', function() {
    it('input node with an aria-labelledby attribute seet to a good value; but the target is empty should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<span id='label1'></span><input type='email' aria-labelledby=''>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("372");
       expect(res).toBe('fail');
