describe('String N/A: no track nodes', function() {
    it('no track nodes should be equal to na', function() {
       ...
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("366");
       expect(res).toBe('na');
       // </variant1>
       // <variant2>
       res = LevelAccess_AccessEngine.runTest_returnNumbers("366");
       expect(res).toBe("");       
       // </variant2>
       // <variant3>
       res = LevelAccess_AccessEngine.runTest_returnInstances("366");
...
describe('String Pass: a track node with a kind attribute set to "chapters" and a label attribute set to a text value', function() {
    it('a track node with a kind attribute set to "chapters" and a label attribute set to a text value should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<audio controls><track kind='chapters' label='en'></audio>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("366");
...
describe('String Fail: a track node with a kind attribute set to "chapters" without a label attribute', function() {
    it('a track node with a kind attribute set to "chapters" without a label attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String Fail: a track node with a kind attribute set to "chapters" with a label attribute set to a null value', function() {
    it('a track node with a kind attribute set to "chapters" with a label attribute set to a null value should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<audio controls><track kind='chapters' label=''></audio>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("366");
       expect(res).toBe('fail');
