describe('String N/A: no th nodes', function() {
    it('no th nodes should be equal to na', function() {
       ...
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("389");
       expect(res).toBe('na');
       // </variant1>
       // <variant2>
       res = LevelAccess_AccessEngine.runTest_returnNumbers("389");
       expect(res).toBe("");       
       // </variant2>
       // <variant3>
       res = LevelAccess_AccessEngine.runTest_returnInstances("389");
...
describe('String N/A: th element with a rowspan attribute set to "1"', function() {
...
describe('String N/A: th element with a rowspan attribute set to ""', function() {
...
describe('String Pass: th element with a rowspan attribute set to "2" and an id attribute set to a non-null value', function() {
    it('th element with a rowspan attribute set to "2" and an id attribute set to a non-null value should be equal to pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<table><tr><th rowspan='2' id='hello'>Hello</th><td>Hello</td><td>Hello</td></tr></table>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("389");
       expect(res).toBe('pass');
...
describe('String Fail: th element with a rowspan attribute set to "2" without a scope attribute set to "rowgroup"; or an id set to a non-null value', function() {
    it('th element with a rowspan attribute set to "2" without a scope attribute set to "rowgroup"; or an id set to a non-null value should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<table><tr><th rowspan='2'>Hello</th><td>Hello</td><td>Hello</td></tr></table>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("389");
...
describe('String Fail: th element with a rowspan attribute set to "2" with a scope attribute set to ""; and no id attribute', function() {
    it('th element with a rowspan attribute set to "2" with a scope attribute set to ""; and no id attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<table><tr><th rowspan='2' scope=''>Hello</th><td>Hello</td><td>Hello</td></tr></table>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("389");
       expect(res).toBe('fail');
...
describe('String Fail: th element with a rowspan attribute set to "2" with an id attribute set to ""; and no scope attribute', function() {
    it('th element with a rowspan attribute set to "2" with an id attribute set to ""; and no scope attribute should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<table><tr><th rowspan='2' id=''>Hello</th><td>Hello</td><td>Hello</td></tr></table>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("389");
       expect(res).toBe('fail');
