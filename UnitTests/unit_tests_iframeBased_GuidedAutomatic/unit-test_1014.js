describe('String N/A: no nodes', function() {
    it('no nodes should be equal to na', function() {
       ...
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1014");
       expect(res).toBe('na');
       // </variant1>
       // <variant2>
       res = LevelAccess_AccessEngine.runTest_returnNumbers("1014");
       expect(res).toBe("");       
       // </variant2>
       // <variant3>
       res = LevelAccess_AccessEngine.runTest_returnInstances("1014");
...
describe('String N/A: a span node with a lang attribute set to a null value and a role attribute set to the text value "presentation"', function() {
    it('a span node with a lang attribute set to a null value and a role attribute set to the text value "presentation" should be equal to na', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<span lang='' role='presentation'>Bonjour</span>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1014");
       expect(res).toBe('na');
...
describe('String N/A: a span node with a lang attribute set to a null value and a style attribute set to the text value "display:none;"', function() {
    it('a span node with a lang attribute set to a null value and a style attribute set to the text value "display:none;" should be equal to na', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = "<span lang='' style='display:none;'>Bonjour</span>";
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
       // <variant1>
       var res = LevelAccess_AccessEngine.runTest_returnOutcome("1014");
       expect(res).toBe('na');
...
describe('String Pass: a span tag that has a lang attribute set to a text value that does not start with an IANA primary language value e.g. "data"', function() {
    it('a span tag that has a lang attribute set to a text value that does not start with an IANA primary language value e.g. "data" should be a pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String Pass: a span tag that has a lang attribute set to a text value that does not start with an IANA primary language value e.g. "d"', function() {
    it('a span tag that has a lang attribute set to a text value that does not start with an IANA primary language value e.g. "d" should be a pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String Pass: a span tag that has a lang attribute set to a text value that is not formatted correctly e.g. "en_us"', function() {
    it('a span tag that has a lang attribute set to a text value that is not formatted correctly e.g. "en_us" should be a pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String Pass: two span tags that has a lang attribute set to a text value that does not start with an IANA primary language value e.g. "data"', function() {
    it('two span tags that has a lang attribute set to a text value that does not start with an IANA primary language value e.g. "data" should be a pass', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
...
describe('String Fail: a span node with a lang attribute set to a null value', function() {
   it('an span node with a lang attribute set to a null value should be equal to fail', function() {
      document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
