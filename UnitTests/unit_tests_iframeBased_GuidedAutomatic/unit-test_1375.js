describe(`String N/A (main page): page with empty head and body`, function () {
    it(`page with empty head and body should be equal to na`, function () {
        ...
        // <variant1>
        var res = LevelAccess_AccessEngine.runTest_returnOutcome("1375");
        expect(res).toBe("na");
        // </variant1>
        // <variant2>
        res = LevelAccess_AccessEngine.runTest_returnNumbers("1375");
        expect(res).toBe("");
        // </variant2>
        // <variant3>
        res = LevelAccess_AccessEngine.runTest_returnInstances("1375");
...
describe(`String N/A (main page): a single title node inside the head node`, function () {
    it(`a single title node inside the head node should be equal to na`, function () {
...
describe(`String N/A (main page): a single title node inside the body node`, function () {
    it(`a single title node inside the body node should be equal to na`, function () {
        document.head.innerHTML = "";
...
describe(`String N/A (main page): empty title node provided in head`, function () {
    it(`empty title node provided in head should be equal to na`, function () {
...
describe(`String Fail (iframe): empty title node provided in head`, function () {
...
describe(`String N/A (main page): empty title node provided in body`, function () {
    it(`empty title node provided in body should be equal to na`, function () {
        document.head.innerHTML = "";
...
describe(`String Fail (iframe): empty title node provided in body`, function () {
...
describe(`String N/A (main page): two title elements in the head (second is empty)`, function () {
    it(`two title elements in the head (second is empty) should be equal to na`, function () {
...
describe(`String N/A (main page): two title elements in the head (first is empty)`, function () {
    it(`two title elements in the head (first is empty) should be equal to na`, function () {
...
describe(`String Fail (iframe): two title elements in the head (first is empty)`, function () {
...
describe(`String Fail (iframe): two title elements in the body (first is empty)`, function () {
...
describe(`String N/A (main page): one empty title element in the head and one title element (with text) in the body`, function () {
    it(`one empty title element in the head and one title element (with text) in the body should be equal to na`, function () {
        document.head.innerHTML = "<title></title>";
...
describe(`String Fail (iframe): one empty title element in the head and one title element (with text) in the body`, function () {
...
describe(`String N/A (main page): an svg with a title element that is not empty and a document title element that is empty`, function () {
    it(`an svg with a title element that is not empty and a document title element that is empty should be equal to na`, function () {
        document.head.innerHTML = "";
        document.body.innerHTML =
        `
...
describe(`String Fail (iframe): an svg with a title element that is not empty and a document title element that is empty`, function () {
...
describe(`String N/A (main page): a div with a title element in the body`, function () {
    it(`a div with a title element in the body should be equal to na`, function () {
        document.head.innerHTML = "";
