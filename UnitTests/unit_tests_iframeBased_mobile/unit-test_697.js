describe('String Pass: android.widget.RadioButton Appium XML transform with aria-checked set to true', function() {
...
describe('String Fail: android.widget.RadioButton Appium XML transform with aria-checked set to a non-boolean', function() {
    it('Appium XML transform with aria-checked set to a non-boolean should be equal to fail', function() {
       document.querySelector("#testing").contentWindow.document.head.innerHTML = "";
       document.querySelector("#testing").contentWindow.document.body.innerHTML = '<div data-xmlnodetype="android.widget.RadioGroup" data-resource-id="com.levelaccess.exampleandroidapp:id/radioGroup" data-xmlattmapping="content-desc:aria-label;bounds-width:css-width;bounds-height:css-height;bounds-x:css-top;bounds-y:css-left;" role="radiogroup" aria-label="some label text" style="position:absolute;width:498px;height:1114px;left:582px;top:1366px;"><div role="radio" data-xmlnodetype="android.widget.RadioButton" aria-checked="@checked" data-resource-id="@resource-id" data-xmlattmapping="checked:aria-checked;content-desc:aria-label;text:title;bounds-width:css-width;bounds-height:css-height;bounds-x:css-top;bounds-y:css-left;" aria-label="@content-desc" title="@text" style="position:absolute;width:@width_px;height:@height_px;left:@x_px;top:@y_px;"></div></div>';
       LevelAccess_AccessEngine.setWindowUnderTest(document.querySelector("#testing").contentWindow);
