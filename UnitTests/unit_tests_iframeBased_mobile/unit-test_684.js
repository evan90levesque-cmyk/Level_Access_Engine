describe('String Pass: XCUIElementTypeButton Appium XML transform with aria-label populated', function() {
...
describe('String Fail: XCUIElementTypeButton Appium XML transform with aria-label empty', function() {
